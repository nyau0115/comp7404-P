...
def dmn_start():
    ...
    parser.add_argument('--network', type=str, default="dmn_fast", help='embeding size (50, 100, 200, 300 only)')
...
def dmn_mid(args):
    ...
    babi_train_raw, babi_test_raw = babi_utils.get_babi_raw(args.babi_id, args.babi_test_id)
